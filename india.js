...
// function assigndata(total,states) {
//     console.log(total);
//     console.log(states);
//     let i;
//     for (i = 1; i < states.length; i++) {
//         // text += cars[i] + "<br>";
//         // fetcheddata+= "<tr data-toggle=\"modal\" data-id="+states[i].state+" data-target=\"#exampleModalCenter\"><th>"+states[i].state+"</th><td>"+states[i].confirmed+"</td><td>"+states[i].active+"</td><td>"+states[i].recovered+"</td><td>"+states[i].deaths+"</td></tr>"
//     fetcheddata+= "<tr data-toggle=\"modal\" data-target=\"#orderModal\" data-id="+i+"><th>"+states[i].state+"</th><td>"+states[i].confirmed+"</td><td>"+states[i].active+"</td><td>"+states[i].recovered+"</td><td>"+states[i].deaths+"</td></tr>"
//     }
...
// //     //     let getIdFromRow = $(event.target).closest('tr').data('id'); //get the id from tr
// //     //     console.log(getIdFromRow);
            
// //     //       //make your ajax call populate items or what even you need
// //     //     $(this).find('#modalbody').html($('<b> Order Id selected: ' + getIdFromRow  + '</b>'))
// //     // });
    
// //     $(".table-dark").find('tr[data-id]').on('click', function () {
...
// //         $('.modaldataaa').html($('hi'));
// //         $('.modaldataaa').html($('<b> Order Id selected: ' + $(this).data('id') + '</b>'));
// //         console.log($(this).data('id'));
// //         // console.log(state[$(this).data('id')]);
